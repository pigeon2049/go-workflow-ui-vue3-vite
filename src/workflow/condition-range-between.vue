<template>
  <div class="range-between">
    <span class="range-group">
      <ConditionRangeBetweenNumber :value="num1" />
      <ConditionRangeBetweenSelect :value="val1" />
    </span>
    <span class="range-group-label">{{ data.paramLabel }}</span>
    <span class="range-group">
      <ConditionRangeBetweenSelect :value="val2" />
      <ConditionRangeBetweenNumber :value="num2" />
    </span>
  </div>
</template>
<script>
